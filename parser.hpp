...
int parseMetadata(parameter * & params, const int numparam, metadata & sim, cosmology & cosmo, icsettings & ic)
{
	...
	COUT << " Omega_g = " << cosmo.Omega_g << endl;
	...
	COUT << " Omega_ur = " << cosmo.Omega_ur << endl;
	...
	COUT << " Omega CDM = " << cosmo.Omega_cdm << endl;
	cosmo.Omega_m = cosmo.Omega_cdm + cosmo.Omega_b;
	COUT << " Omega M = " << cosmo.Omega_m << endl;
	COUT << " Omega rad = " << cosmo.Omega_rad << endl;
